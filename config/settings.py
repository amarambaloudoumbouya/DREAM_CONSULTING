...
# Uploads vidéo volumineux : spill disque tôt, plafond requête 500 Mo
FILE_UPLOAD_MAX_MEMORY_SIZE = 2 * 1024 * 1024  # 2 Mo → TemporaryUploadedFile
DATA_UPLOAD_MAX_MEMORY_SIZE = 500 * 1024 * 1024  # 500 Mo
